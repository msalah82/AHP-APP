...
if "criteria_input" not in st.session_state:
    st.session_state.criteria_input = "Cost, Quality, Time"
if "alternative_input" not in st.session_state:
    st.session_state.alternative_input = "Option A, Option B, Option C"

criteria_input = st.text_input("Enter criteria (comma-separated)", st.session_state.criteria_input, key="criteria_input")
alternative_input = st.text_input("Enter alternatives (comma-separated)", st.session_state.alternative_input, key="alternative_input")
